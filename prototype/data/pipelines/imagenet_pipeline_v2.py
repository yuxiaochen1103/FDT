# try:
#     import prototype.linklink.dali as link_dali  # noqa
# except ModuleNotFoundError:
#     print('import prototype.linklink.dali failed, prototype.linklink version should >= 0.2.0')
...
class CustomPipeline(object):
    r"""CustomPipeline will work with :class:`prototype.linklink.dali.DataLoader` to
